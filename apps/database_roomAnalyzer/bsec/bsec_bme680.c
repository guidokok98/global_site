                  ...
                  float breath_voc_equivalent)
{
  ...
  fprintf(fptr,"%f",iaq);
  fprintf(fptr,",");
  fprintf(fptr,"%d",iaq_accuracy);
  fprintf(fptr,",");
  fprintf(fptr,"%f",temperature);
  fprintf(fptr,",");
  fprintf(fptr,"%f",humidity);
  fprintf(fptr,",");
  fprintf(fptr,"%f",pressure);
  fprintf(fptr,",");
  fprintf(fptr,"%f",raw_temperature);
  fprintf(fptr,",");
  fprintf(fptr,"%f",raw_humidity);
  fprintf(fptr,",");
  fprintf(fptr,"%f",gas);
  fprintf(fptr,",");
  fprintf(fptr,"%f",static_iaq);
  fprintf(fptr,",");
  fprintf(fptr,"%f",co2_equivalent);
  fprintf(fptr,",");
  fprintf(fptr,"%f",breath_voc_equivalent);
  fclose(fptr);
  fflush(stdout);
}
